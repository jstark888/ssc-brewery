...
public class BeerOrderController {
    ...
    @BeerOrderPickupPermission //The Pickup order action is not a typical CRUD type action. It's an API action, thus best practice would be to define a permission for the action.
